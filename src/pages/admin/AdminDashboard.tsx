...
import { Newspaper, Calendar, Users, MessageSquare, BookOpen, ClipboardList, UserCheck, Archive, FileText, Shield } from "lucide-react";
...
export default function AdminDashboard() {
  ...
  const stats = [
    { label: "News", value: newsCount, icon: Newspaper, path: "/admin/news", color: "text-blue-500 bg-blue-50" },
    { label: "Eventi", value: eventsCount, icon: Calendar, path: "/admin/events", color: "text-green-500 bg-green-50" },
    { label: "Nuove Iscrizioni", value: regsCount, icon: BookOpen, path: "/admin/registrations", color: "text-orange-500 bg-orange-50" },
    { label: "Messaggi Nuovi", value: msgsCount, icon: MessageSquare, path: "/admin/submissions", color: "text-purple-500 bg-purple-50" },
    { label: "Organico Arbitri", value: refereesCount, icon: UserCheck, path: "/admin/referees", color: "text-primary bg-primary/10" },
    { label: "Giustificazioni", value: justCount, icon: Archive, path: "/admin/justifications", color: "text-yellow-600 bg-yellow-50" },
    { label: "Utenti", value: usersCount, icon: Shield, path: "/admin/users", color: "text-red-500 bg-red-50" },
  ];
