    ...
    <AdminLayout>
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">{reports?.length ?? 0} categorie configurate</p>
        </div>
      ...
      {!isLoading && !error && (
        <div className="space-y-3">
          ...
          {reports?.length === 0 && <p className="text-muted-foreground text-center py-8">Nessuna categoria referti.</p>}
        </div>
      )}
    </AdminLayout>
  );
